 ...
 * @author Estela
 */
public class FormularioModificarCoche 
{
    ...
    public FormularioModificarCoche() {
    }

    public FormularioModificarCoche(String marca, String modelo, String color, String anno, String cilindrada, String caballos) {
        this.marca = marca;
        this.modelo = modelo;
        this.color = color;
        this.anno = anno;
